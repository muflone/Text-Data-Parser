...
from text_data_parser.constants import *
...
setup(
  ...
  data_files=[
    ...
    ('share/applications', ['data/textdataparser.desktop']),
    ('share/doc/textdataparser', list(chain(glob('doc/*'), glob('*.md')))),
    ('share/man/man1', ['man/textdataparser.1']),
    ('share/textdataparser/ui', glob('ui/*')),
  ],
  cmdclass = {
